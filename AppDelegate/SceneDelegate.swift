...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func tabBarHomeRoot(){
        ...
        let nextVC = mainStoryBoard.instantiateViewController(withIdentifier: "HomeTabBar") as! HomeTabBar
    ...
    func sosRoot(){
        let mainStoryBoard = UIStoryboard(name: "Main", bundle: nil)
        let nextVC = mainStoryBoard.instantiateViewController(withIdentifier: "SosVC") as! SosVC
        let nav = UINavigationController.init(rootViewController: nextVC)
        nav.isNavigationBarHidden = true
        UIApplication.shared.windows.first?.rootViewController = nav
    }
